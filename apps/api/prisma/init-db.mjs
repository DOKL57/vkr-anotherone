...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS "TelegramUser" ("id" TEXT PRIMARY KEY, "telegramId" BIGINT NOT NULL UNIQUE, "username" TEXT, "firstName" TEXT NOT NULL, "lastName" TEXT, "role" "EmployeeRole" NOT NULL, "employeeId" TEXT, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP);`,
  ...
  `CREATE TABLE IF NOT EXISTS "ChatSession" ("id" TEXT PRIMARY KEY, "telegramUserId" TEXT, "title" TEXT, "lastIntent" TEXT, "contextJson" JSONB, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP);`,
  ...
  `ALTER TABLE "TelegramUser" DROP CONSTRAINT IF EXISTS "TelegramUser_employeeId_fkey";`,
  ...
  `ALTER TABLE "ChatSession" DROP CONSTRAINT IF EXISTS "ChatSession_telegramUserId_fkey";`,
  ...
  `ALTER TABLE "TelegramUser" ADD CONSTRAINT "TelegramUser_employeeId_fkey" FOREIGN KEY ("employeeId") REFERENCES "Employee"("id") ON DELETE SET NULL ON UPDATE CASCADE;`,
  ...
  `ALTER TABLE "ChatSession" ADD CONSTRAINT "ChatSession_telegramUserId_fkey" FOREIGN KEY ("telegramUserId") REFERENCES "TelegramUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;`,
