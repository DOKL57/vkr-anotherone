...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS "Project" ("id" TEXT PRIMARY KEY, "name" TEXT NOT NULL, "venue" TEXT, "customer" TEXT, "startsAt" TIMESTAMP(3), "endsAt" TIMESTAMP(3), "archivedAt" TIMESTAMP(3), "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP);`,
