...
async function main() {
  ...
  const project = await one('INSERT INTO "Project" ("id","name","venue","customer","startsAt","endsAt") VALUES (gen_random_uuid()::text,$1,$2,$3,$4,$5) RETURNING id', ["Фестиваль Город Звук", "ДК Центральный", "ООО Организация мероприятий", new Date("2026-05-01T10:00:00.000Z"), new Date("2026-05-03T23:00:00.000Z")]);
